...
namespace ShopWebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult RegisterRole()
        {
            ...
            ViewBag.UserName = new SelectList(applicationDbContext.Users.ToList(), "UserName", "UserName");
            return View();
        }
        ...
        {
            var userId = applicationDbContext.Users.Where(i => i.UserName == user.UserName).Select(s => s.Id);
            string updateId = "";
